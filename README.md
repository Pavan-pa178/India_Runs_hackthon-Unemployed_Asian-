...
A fully transparent, rule-based candidate ranker. No embeddings. No LLM calls. No training step. 
Every score can be traced to a specific line of code and a specific reason.
...
- **Claude:** Used Claude for reasoning through the scoring logic and assessing codecorrectness, debugging issues during development, and understanding concepts to help develop ideas for the ranking approach.       

- **ChatGPT:** Understanding key problem constraints, analyzing the job description and Redrob signals, identifying what needed to be built within the hackathon's compute limits.
